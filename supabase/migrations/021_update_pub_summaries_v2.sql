-- Update pub_summaries view to include V2 amenities and fields
-- This migration updates the view created in 018 to include new V2 columns

-- Drop and recreate the view with V2 fields
...
COMMENT ON VIEW pub_summaries IS 'Aggregated pub data including V2 amenities, ratings, prices, and engagement metrics for list views';
