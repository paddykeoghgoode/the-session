    ...
    return (
      <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full text-center">
          <div className="bg-irish-green-500/10 border border-irish-green-500 rounded-lg p-8">
            <svg
              className="w-16 h-16 text-irish-green-500 mx-auto mb-4"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
            ...
            <h2 className="text-2xl font-bold text-cream-100 mb-2">Check Your Email</h2>
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-cream-100">Join The Session</h1>
          <p className="mt-2 text-stout-400">Create an account to submit prices and reviews</p>
        </div>
        ...
        <div className="bg-stout-800 rounded-lg border border-stout-700 p-8">
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-cream-100 mb-2">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 w-full flex items-center justify-center gap-3 bg-stout-700 hover:bg-stout-600 text-cream-100 font-medium py-2 px-4 rounded-lg border border-stout-600 transition-colors"
            >
          ...
          <p className="mt-6 text-center text-sm text-stout-400">
            ...
            <Link href="/auth/login" className="text-irish-green-500 hover:text-irish-green-400">
              Sign in
            </Link>
          </p>
        </div>
